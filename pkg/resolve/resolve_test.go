...
func Test_ImageTags_Pod(t *testing.T) {
	...
	assertVolume(t, node, "image4@sha256:9ca97c69ef7957a20eb9747ae40ae1d7c1326736b68fc75a74b25742c3f1fecd", "spec", "volumes", "[name=imagevolume0]", "image")
	assertVolume(t, node, "image5@sha256:51077af79f2b143d082e17640704cec760301d4e266ec868147f0cef3e329a48", "spec", "volumes", "[name=imagevolume1]", "image")
	assertVolume(t, node, "image4", "spec", "volumes", "[name=othervolume0]", "other")
	assertVolume(t, node, "image5", "spec", "volumes", "[name=othervolume1]", "other")
}
